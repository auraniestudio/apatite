...
BUCKET="apatite-website-production"
CLOUDFRONT_DISTRIBUTION_ID="E3EWBGJQOR7S8E"
DIST="dist"
...
echo "Done."
echo "  S3 Bucket:  https://apatite-website-production.s3.ap-southeast-2.amazonaws.com"
echo "  Live URL:   https://apatite.io"